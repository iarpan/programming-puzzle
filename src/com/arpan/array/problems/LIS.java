...
class LIS {
	 ...
	 * 
	 * 1)	Length of LIS ending with element arr[n-1]. We use max_ending_here for
	 * 		this purpose.
	 * 
	 * 2) 	Overall maximum as the LIS may end with an element before
	 * 		arr[n-1] max_ref is used this purpose. The value of LIS of full array of
	 * 		size n is stored inmax_ref which is our final result
	 */
